...
class Vender_requersts extends Authenticatable
{
    ...
    public function getImageAttribute($value)    {
        if ($value) {
            if (filter_var($value, FILTER_VALIDATE_URL) === FALSE) {
                return url('uploads/images/vender_requersts/' . $value);
            } else {
                return $value;
            }
        } else {
            return url('uploads/images/vender_requersts/defualtUser.jpg');
        }
    }
