            ...
            <div class="container">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">
                      ...
                      <a href="{{ url('/#vendersSection') }}">@lang('website.vender')</a>


                  </li>

{{--                  <li class="breadcrumb-item">@lang('website.vender')</li>--}}
                  <li class="breadcrumb-item active">{{$category->name}}</li>
                </ol>
            </div>
        </div>

        {{-- {{$vender_id =$category->id}} --}}
		        ...
		        <div class="owl-carousel" id="categoris_slider">
		            @foreach($categories as $category)
                        ...
                        <div class="item_categoris">
                            <a href="{{route('vender_category_list',[$V_id,$category->id,Str::slug($category->name)])}}">
