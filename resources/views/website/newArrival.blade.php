...
@section('title') @lang('website.New Arrival') @endsection
@section('css')
    ...
    <style>
        ...
        @media (max-width: 767px) {
            .item_categoris p, .item_venders p ,.btn-site span  {
                font-size: 13px;
                margin: 10px 5px;
                white-space: normal;
                -webkit-line-clamp: 2;
		        ...
		        <div class="head-sort">
		            ...
		            <div class="form-group">
		                <select class="form-control" onchange="location = this.value;">
		                    ...
		                    <option @if(Request::get('sort')=='min') {{'selected'}} @endif value="{{url(app()->getLocale().'/products/NewArrival?sort=min')}}">@lang('website.Min price')</option>
		                    <option @if(Request::get('sort')=='max') {{'selected'}} @endif value="{{url(app()->getLocale().'/products/NewArrival?sort=max')}}">@lang('website.Max Price')</option>
