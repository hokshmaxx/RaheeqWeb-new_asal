...
@section('title') @lang('website.OFFERS') @endsection
@section('css')
		        ...
		        <div class="head-sort">
		            ...
		            <div class="form-group">
		                <select class="form-control" onchange="location = this.value;">
		                    ...
		                    <option @if(Request::get('sort')=='min') {{'selected'}} @endif value="{{url(app()->getLocale().'/offers?sort=min')}}">@lang('website.Min price')</option>
		                    <option @if(Request::get('sort')=='max') {{'selected'}} @endif value="{{url(app()->getLocale().'/offers?sort=max')}}">@lang('website.Max Price')</option>
