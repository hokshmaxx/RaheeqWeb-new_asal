          ...
          <div>
              <div class="btn-group mb-2 m-md-3 mt-md-0 ml-2 ">
               ...
               <a href="{{url(getLocal().'/admin/exportvender')}}" class="btn btn-secondary  mr-2 btn-success">
                    ...
                    <a href="{{url(getLocal().'/admin/Vitamin/create')}}" class="btn btn-secondary  mr-2 btn-success">
  ...
  <div class="d-flex flex-column-fluid">
                      ...
                      <thead>
                          <tr>
                            <th class="wd-1p no-sort">
                              ...
                              <th class="wd-25p"> Decription </th>
                              <th class="wd-10p"> Arabic Title </th>
                              <th class="wd-10p"> Arabic Decription</th>
                                ...
                                <div class="col-md-6">
                                      <div class="form-group ">
                                          ...
                                          <select class="form-control form-control-solid" name ="gender" required>
                                              <option value="">{{__('cp.selecxt')}}</option>
    ...
    <script>
        ...
        var dataTable = $('#kt_datatable1').DataTable({
            ...
            ajax: {
                url: "{{url(app()->getLocale().'/admin/Vitamin')}}",
                type: 'GET',
        ...
        function delete_adv(id, iss_id, e) {
            ...
            e.preventDefault();
            var url = '{{url(getLocal()."/admin/Vitamin")}}/' + id;
