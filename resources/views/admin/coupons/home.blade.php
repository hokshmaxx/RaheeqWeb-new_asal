        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <button type="button" class="btn btn-secondary event" href="#cancel_activation" role="button"
                    ...
                    <a href="{{url(getLocal().'/admin/coupons/create')}}" class="btn btn-secondary  mr-2 btn-success">
                                ...
                                <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/coupons')}}">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{url(app()->getLocale().'/admin/coupons')}}" type="submit" class="btn sbold btn-default btnRest">{{__('cp.reset')}}
                                ...
                                @forelse($items as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            ...
                                            {{--                                                          </div>--}}
                                            {{--                                                        </div>--}}
                                            <a href="{{url(getLocal().'/admin/coupons/'.$one->id.'/edit')}}"
