...
{{--                        </button>--}}
                    ...
                    <a href="{{url(getLocal().'/admin/banners/create')}}" class="btn btn-secondary  mr-2 btn-success" data-target="#basicModal" data-toggle="modal">
...
$(document).on('click','.edit_item_btn',function (e) {
    ...
    function delete_adv(id, iss_id, e) {
            ...
            var url = '{{url(getLocal()."/admin/banners")}}/' + id;
