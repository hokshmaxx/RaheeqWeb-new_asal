<td class="v-align-middle wd-15p optionAddHours">
    <a data-id="{{$row->id}}"  class="btn btn-sm btn-clean btn-icon edit_item_btn" title="{{__('cp.edit')}}">
        <i class="la la-edit"></i>
    </a>
    
           <a href="#myModal{{$row->id}}" role="button"  data-toggle="modal" class="btn btn-xs red tooltips"><i class="fa fa-times" aria-hidden="true"></i></a>
