        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
          ...
          <div class="d-flex align-items-center flex-wrap mr-1">
              <div class="d-flex align-items-baseline mr-5">
                  <h3>{{ucwords(__('cp.variant'))}}</h3>
              </div>
          </div>

          <div>
                <a href="{{url(getLocal().'/admin/varintType/create')}}" class="btn btn-secondary  mr-2 btn-success">
  ...
  <div class="d-flex flex-column-fluid">
                    ...
                    <table class="table table-bordered table-hover table-checkable"  style="margin-top: 13px !important" id="kt_datatable1">
                      ...
                      <thead>
                          <tr>
                              ...
                              <th class="wd-25p"> {{ucwords(__('cp.varianten'))}}</th>
                              <th class="wd-25p"> {{ucwords(__('cp.variantar'))}}</th>
    ...
    <script>
        ...
        var dataTable = $('#kt_datatable1').DataTable({
           ...
           ajax: {
            url: "{{url(app()->getLocale().'/admin/varintType')}}",
            type: 'GET',
        ...
        function delete_adv(id, iss_id, e) {
                ...
                var url = '{{url(getLocal()."/admin/varintType")}}/' + id;
