                        ...
                        <div class="form-body">
                            ...
                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                       <input type="text" class="form-control" name="question_{{$locale->lang}}"  id="question_{{$locale->lang}}"
                                             ...
                                             <div class="form-group">
                                                  @foreach($locales as $locale)   
                                                    ...
                                                    <div class="col-md-3">
                                                       <textarea class="form-control" name="answer_{{$locale->lang}}" id="answer_{{$locale->lang}}" rows="7" required>{{ old('answer_'.$locale->lang) }}</textarea>
                                                    </div>
                                                     @endforeach
                                                </div>
