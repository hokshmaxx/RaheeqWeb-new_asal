      ...
      <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
          ...
          <div class="d-flex align-items-center flex-wrap mr-1">
              <div class="d-flex align-items-baseline mr-5">
                  <h3>{{ucwords(__('cp.RequestVender'))}}</h3>
              </div>
          </div>
          ...
          <div>
              {{-- <div class="btn-group mb-2 m-md-3 mt-md-0 ml-2 "> --}}
                ...
                {{-- <button type="button" class="btn btn-secondary event" href="#activation" role="button" data-toggle="modal">
  ...
  <div class="d-flex flex-column-fluid">
    ...
    <script>
        ...
        var dataTable = $('#kt_datatable1').DataTable({
            ...
            ajax: {
                url: "{{url(app()->getLocale().'/admin/request_vender')}}",
                type: 'GET',
