											...
											<div class="card-body pt-4">
												...
												<div class="d-flex align-items-center">
													...
													<div>
														...
														<div class="text-muted">{{__('cp.venders')}}</div>
														<!--<div class="mt-2">-->
												...
												<div class="navi navi-bold navi-hover navi-active navi-link-rounded">
													{{-- <div class="navi-item mb-2">
														<a href="{{url(getLocal().'/admin/venders/'.$item->id.'/show')}}" class="navi-link py-4 @if(Route::currentRouteName() == "admin.venders.show") active  @endif">
													...
													<div class="navi-item mb-2">
														<a href="{{url(getLocal().'/admin/vender/'.$item->id.'/edit')}}" class="navi-link py-4 @if(Route::currentRouteName() == "admin.venders.edit") active  @endif">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
													...
													{{-- <div class="navi-item mb-2">
                                                        <a href="{{url(getLocal().'/admin/venders/'.$item->id.'/addresses')}}" class="navi-link py-4 @if(Route::currentRouteName() == "admin.venders.addresses") active  @endif">
                                                            <span class="navi-icon mr-2">
                                                    ...
                                                    {{-- <div class="navi-item mb-2">
                                                        <a href="{{url(getLocal().'/admin/orders?user_id='.$item->id)}}" class="navi-link py-4 @if(Route::currentRouteName() == "admin.venders.orders") active  @endif">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                         xmlns:xlink="http://www.w3.org/1999/xlink"
													...
													<!-- <div class="navi-item mb-2">
														<a href="{{url(getLocal().'/admin/venders/'.$item->id.'/edit_password')}}" class="navi-link py-4  @if(Route::currentRouteName() == "admin.venders.edit_password") active  @endif">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
