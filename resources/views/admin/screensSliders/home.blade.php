            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline mr-5">
                        <h3>{{ucwords(__('cp.screensSliders'))}}</h3>
                    </div>
                </div>
                <!--end::Info-->
                <!--begin::Toolbar-->
                ...
                <div>
                    ...
                    <a href="{{url(getLocal().'/admin/screensSliders/create')}}" class="btn btn-secondary  mr-2 btn-success">
                                ...
                                @forelse($items as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            ...
                                            <a href="{{url(getLocal().'/admin/screensSliders/'.$one->id.'/edit')}}"
