            ...
            <div class="d-flex flex-column-fluid">
                ...
                <div class="container">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <form class="form" method="post" action="{{url(app()->getLocale().'/admin/customerComments')}}" enctype="multipart/form-data" id="form" role="form" >
                            @csrf
                                            ...
                                            @foreach($locales as $locale)
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name_{{$locale->lang}}" class="form-control form-control-solid" name="name_{{$locale->lang}}" value="{{ old('name_'.$locale->lang) }}" required />
                                                    </div>
                                                </div> 
                                                                                @endforeach 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="customer_job_{{$locale->lang}}" class="form-control form-control-solid" name="customer_job_{{$locale->lang}}" value="{{ old('customer_job_'.$locale->lang) }}" required />
                                                    </div>
                                                </div> 
                                                                                @endforeach 
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="comment_{{$locale->lang}}" class="form-control form-control-solid" name="comment_{{$locale->lang}}" value="{{ old('comment_'.$locale->lang) }}" required />
                                                    </div>
                                                </div>    
                                                                               @endforeach 
