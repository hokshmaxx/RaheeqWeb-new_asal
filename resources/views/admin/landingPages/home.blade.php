        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/landingPage/create')}}" style="margin-right: 5px"
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/landingPage/'.$one->id.'/edit')}}"
...
@section('script')
    <script>
        function delete_adv(id, iss_id, e) {
            ...
            var url = '{{url(getLocal()."/admin/landingPage")}}/' + id;
