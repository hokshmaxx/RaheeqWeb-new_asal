...
@section('title') {{__('common.RequestService')}}
@endsection
@section('css')
@endsection
        ...
        <div class="portlet-body">
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('common.username'))}}</th>
                    <th> {{ucwords(__('common.price'))}} ({{__('common.kd')}})</th>
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                ...
                                <a data-placement="top" data-original-title="{{__('common.delete')}} " href="#myModal{{$item->id}}" role="button"  data-toggle="modal" class="btn btn-xs red tooltips">
