                ...
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/subadmin/products/'.$item->id)}}"
                        ...
                        <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input onkeyup=" if (/\D/g.test(this.value)) this.value = this.value.replace(/[^0-9.]/g,'')"  type="text" class="form-control" name="offer_price" value="{{$item->offer_price }}"
                                               placeholder=" {{__('product.current_price')}}" {{ old('offer_price') }} required>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="col-md-8">
                                    <div class="mt-checkbox-inline">
                                        <label class="mt-checkbox">
                                            <input type="checkbox" name="status" id="inlineCheckbox1" value="1" @if($item->status == 'active') checked @endif> {{__('common.status')}}
                                            <span></span>
                                        </label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2">{{__('common.Availability')}} {{__('product.product')}}
                                    <span class="symbol">*</span>
                                </label>
                                <div class="col-md-8">
                                    <div class="mt-checkbox-inline">
                                        <label class="mt-checkbox">
                                            <input type="checkbox" name="availability" id="inlineCheckbox1" value="1" @if($item->availability == 1) checked @endif> {{__('common.Availability')}}
                                            <span></span>
                                        </label>
