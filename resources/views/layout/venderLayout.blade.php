			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						<!--begin::Logo-->
						<a href="{{ url(app()->getLocale().'/vender/home') }}" class="brand-logo">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
                                    ...
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "home") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/vender/home')}}" class="menu-link">
                                   ...
                                   {{-- @if(can(['users-show' , 'users-create' , 'users-edit' , 'users-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "users") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/vender/users')}}" class="menu-link">
                                           <span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <polygon points="0 0 24 0 24 24 0 24"/>
									 ...
									 <li class="menu-item {{(explode("/", request()->url())[5] == "products") ? "menu-item-here" : ''}}"                                     aria-haspopup="true">
                                        <a href="{{url(getLocal().'/vender/products')}}" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									  ...
									  <li class="menu-item {{(explode("/", request()->url())[5] == "orders") ? "menu-item-here" : ''}}"                                     aria-haspopup="true">
										  <a href="{{url(getLocal().'/vender/orders')}}" class="menu-link">
											  <span class="svg-icon menu-icon">
												  <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
												  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								@endif --}}
									...
									<li class="menu-item {{(explode("/", request()->url())[5] == "coupons") ? "menu-item-here" : ''}}"
										aria-haspopup="true">
										<a href="{{url(getLocal().'/vender/coupons')}}" class="menu-link">
													<span class="svg-icon menu-icon">
														<svg
							...
							<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
								...
								<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
									...
									<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        ...
                                        <a href="{{url(app()->getLocale().'/vender/home')}}" class="text-dark font-weight-bold">{{__('cp.home')}}</a>
                                        </li>
                                        <li class="breadcrumb-item">
							...
							<div class="topbar">
								...
								<div class="topbar-item">
									<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{auth()->guard('vender')->user()->name}}</span>
										<span class="symbol symbol-35 symbol-light-success">
											<span class="symbol-label font-size-h5 font-weight-bold">{{mb_substr(auth()->guard('vender')->user()->name,0,1,'utf-8')}}</span>
										</span>
									</div>
								</div>
								<!--end::User-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('{{auth()->guard('vender')->user()->image}}')"></div>
						<i class="symbol-badge bg-success"></i>
					</div>
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{auth()->guard('vender')->user()->name}}</a>
						...
						<div class="navi mt-2">
							<a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary">{{auth()->guard('vender')->user()->email}}</span>
								</span>
							</a>
							<a href="{{url(getLocal().'/vender/logout')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">{{__('cp.logout')}}</a>
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<a href="{{url(getLocal().'/vender/editMyProfile')}}" class="navi-item">
						<div class="navi-link">
					...
					<!--end:Item-->
					<!--begin::Item-->
					<a href="{{url(getLocal().'/vender/changeMyPassword')}}" class="navi-item">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
									<i class="la la-key"></i>
					...
					<a href="{{url(getLocal().'/vender/editVenderAddress')}}" class="navi-item">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
									<span class="svg-icon svg-icon-md svg-icon-success">
										...
										<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#1bc5bd}</style><path d="M402.3 344.9l32-32c5-5 13.7-1.5 13.7 5.7V464c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V112c0-26.5 21.5-48 48-48h273.5c7.1 0 10.7 8.6 5.7 13.7l-32 32c-1.5 1.5-3.5 2.3-5.7 2.3H48v352h352V350.5c0-2.1.8-4.1 2.3-5.6zm156.6-201.8L296.3 405.7l-90.4 10c-26.2 2.9-48.5-19.2-45.6-45.6l10-90.4L432.9 17.1c22.9-22.9 59.9-22.9 82.7 0l43.2 43.2c22.9 22.9 22.9 60 .1 82.8zM460.1 174L402 115.9 216.2 301.8l-7.3 65.3 65.3-7.3L460.1 174zm64.8-79.7l-43.2-43.2c-4.1-4.1-10.8-4.1-14.8 0L436 82l58.1 58.1 30.9-30.9c4-4.2 4-10.8-.1-14.9z"/></svg>
										<!--end::Svg Icon-->
									</span>
								</div>
							</div>
							<div class="navi-text">
								<div class="font-weight-bold">{{__('cp.edit_address')}}</div>
								<!--<div class="text-muted">Account settings and more-->
								<!--<span class="label label-light-danger label-inline font-weight-bold">update</span></div>-->
							</div>
						</div>
...
// alert(IDArray);
    ...
    $('.confirmAll').on('click', function (e) {
        ...
        var url = "{{ url(getLocal().'/vender/vender_changeStatus/'.Request::segment(3)) }}";
