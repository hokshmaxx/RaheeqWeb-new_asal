        ...
        <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            <li class="nav-item active start">
                <a href="{{url('/subadmin/home')}}" class="nav-link">
                    <i class="icon-home"></i>
                    <span class="title">{{__('siderbar.dashboard')}}</span>
                </a>
            </li>
            ...
            <li class="nav-item  {{(explode("/", request()->url())[5] == "owner_user") ? "active open" : ''}}">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">{{__('bunch.manage_profile')}}</span>
                ...
                <ul class="sub-menu">
                    <li class="nav-item ">
                        <a href="{{url(getLocal().'/subadmin/owner_user')}}" class="nav-link ">
                            ...
                            <span class="title">{{__('bunch.my_profile')}}</span>
                        </a>
                    </li>
             ...
             <li class="nav-item {{(explode("/", request()->url())[5] == "company") ? "active open" : ''}} ">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">{{__('bunch.my_company')}}</span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item  ">
                        <a href="{{url(getLocal().'/subadmin/company')}}" class="nav-link ">
                            ...
                            <span class="title">{{__('bunch.edit_my_company')}}</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  {{(explode("/", request()->url())[5] == "company_message_notifications") ? "active open" : ''}}">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">{{__('siderbar.all_notifications')}}</span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item ">
                        <a href="{{url(getLocal().'/subadmin/company_message_notifications')}}" class="nav-link ">
                            <i class="fa fa-server"></i>
                            <span class="title">{{__('siderbar.all_messages')}}</span>
                        </a>
                    </li>
            ...
            <li class="nav-item {{(explode("/", request()->url())[5] == "orders") ? "active open" : ''}} ">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">{{__('siderbar.orders')}}</span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item  ">
                        <a href="{{url(getLocal().'/subadmin/orders')}}" class="nav-link ">
                            <i class="fa fa-server"></i>
                            <span class="title">{{__('siderbar.all_orders')}}</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  {{(explode("/", request()->url())[5] == "serviceRequest") ? "active open" : ''}}">
                <a href="javascript:;" class="nav-link nav-toggle">
                    <i class="fa fa-th-large"></i>
                    <span class="title">{{__('print.serviceRequest')}}</span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item ">
                        <a href="{{url(getLocal().'/subadmin/serviceRequest')}}" class="nav-link ">
                            <i class="fa fa-server"></i>
                            <span class="title">{{__('print.all_serviceRequest')}}</span>
                        </a>
                    </li>
            ...
            <li class="nav-item  {{(explode("/", request()->url())[5] == "services") ? "active open" : ''}}">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">{{__('bunch.services')}}</span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item ">
                        <a href="{{url(getLocal().'/subadmin/services')}}" class="nav-link ">
                            <i class="fa fa-server"></i>
                            <span class="title">{{__('bunch.all_services')}}</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{url(getLocal().'/subadmin/services/create')}}" class="nav-link ">
                            <i class="fa fa-plus-square-o"></i>
                            <span class="title">{{__('bunch.new_service')}}</span>
                        </a>
                    </li>
                </ul>
            </li>
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                <li>
                    <a href="{{url('/subadmin/home')}}">{{__('home.home')}}</a>
