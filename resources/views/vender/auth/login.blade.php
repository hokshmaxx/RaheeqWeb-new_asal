						...
						<div class="d-flex flex-column-fluid flex-column flex-center mt-5 mt-lg-0">
							...
							<div class="login-form login-signin">
							   ...
							   @if (count($errors) > 0)
								...
								<!--begin::Form-->
								<form class="form" role="form" novalidate="novalidate" id="kt_login_signin_form"  action="{{url(app()->getLocale().'/vender/login')}}" method="post">
								    @csrf
									...
									<div class="form-group py-3 border-top m-0">
										<input class="form-control h-auto border-0 px-0 placeholder-dark-75" type="Password" placeholder="Password" required name="password" />
									</div>
									...
									<div class="form-group d-flex flex-wrap justify-content-between align-items-center mt-2">
										<button id="kt_login_signin_submit" type="submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3">{{__('cp.Sign_in')}}</button>
										{{-- <a href="{{url(app()->getLocale().'/vender/register')}}">Register Vendor</a> --}}
									</div>
								</form>
								<!--end::Form-->
							</div>
