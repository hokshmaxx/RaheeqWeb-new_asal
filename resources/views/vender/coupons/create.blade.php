        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            {{-- <h1> {{$data[0]->name}} </h1> --}}
                ...
                <div class="d-flex align-items-center">
                    <a href="{{url(getLocal().'/vender/coupons')}}" class="btn btn-secondary  mr-2">{{__('cp.cancel')}}</a>
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <form method="post" action="{{url(app()->getLocale().'/vender/coupons')}}" enctype="multipart/form-data" class="form-horizontal" role="form" id="form">
                        {{ csrf_field() }}
                        ...
                        <div class="row col-sm-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">{{__('cp.select_product')}}</label>
