        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{url(getLocal().'/vender/products')}}" class="btn btn-secondary mr-2">{{__('cp.cancel')}}</a>
...
{{--                                    <div class="form-group">--}}
{{--                                        <label>SKU</label>--}}
{{--                                        <input type="text" class="form-control form-control-solid" name="sku" value="{{ old('sku')}}" required/>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                        <input type="text" class="form-control form-control-solid number-only" name="price" value="{{ old('price')}}" required/>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="col-md-6">--}}
{{--                                    <div class="form-group">--}}
{{--                                        <label>{{__('cp.discount_price')}}</label>--}}
{{--                                        <input type="text" class="form-control form-control-solid number-only" id="discount_price" name="discount_price" value="{{ old('discount_price')}}"/>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="col-md-6">--}}
{{--                                    <div class="form-group">--}}
{{--                                        <label>{{__('cp.price')}}</label>--}}
{{--                                        <input type="text" class="form-control form-control-solid number-only" id="vender_price" name="vender_price" value="{{ old('vender_price')}}"/>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="col-md-6">--}}
{{--                                    <div class="form-group">--}}
{{--                                        <label>{{__('cp.offer_end_date')}}</label>--}}
{{--                                        <input type="date" class="form-control form-control-solid" name="offer_end_date" value="{{ old('offer_end_date')}}"/>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                            </div>
{{--                            <div class="row">--}}
