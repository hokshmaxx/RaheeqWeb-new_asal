                                       ...
                                       <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea id="description_{{$locale->lang}}" class="form-control form-control-solid"
                                                    ...
                                                    id="order" rows="3" required>{{ old('description_'.$locale->lang) }}</textarea>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <!-- <div class="col-md-6">
                                        <div class="form-group ">
                                            <label>{{__('cp.price')}}</label>
                                            <input   type="text"
                                             class="form-control form-control-solid number-only" id="vender_price" name="vender_price" value="{{ old('vender_price')}}"/>
                                        </div>
                                   </div> -->
                                    <div class="col-md-6">
                                          <div class="form-group ">
