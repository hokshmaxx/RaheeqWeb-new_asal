    ...
    <head>
       ...
       body
       {
        ...
        <div class="header">
            <div class="container">
                <div class="logo">
                    <img src="{{$setting->logo}}" width="70" height="70" />
                </div>
                <div class="secHead">
                    <p>فاتورة استلام</p>
                </div>
           ...
           <div class="container">
            ...
            <div class="tableBody">
                ...
                <table id="customers">
                  ...
                  @endforeach
            <tr>
                    <td colspan="5">{{__('cp.sub_total')}}:</td>
                    <td class="text-right" colspan="1"><span>{{$order->sub_total}}</span></td>
                  </tr>
                 
                  <tr>
                    <td colspan="5"> {{__('cp.discount')}}:</td>
                    <td class="text-right" colspan="1"><span>{{$order->discount}}</span></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="text-right" colspan="1"><span>{{@$order->total}}</span></td>
                  </tr>
              </table>
