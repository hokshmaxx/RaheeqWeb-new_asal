        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/vender/orders/'.$order->id)}}"
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{@$one->quantity}}</td>
                                          @if(@$one->offer_price==0)
                                             <td>0</td>
                                          @else
                                            <td>{{@$one->price - @$one->offer_price}}</td>
                                            @endif
                                                    ...
                                                    @if(!empty($one->additions))
                                                        @forelse($one->additions as $additions)
                                                            <tr class="odd gradeX" id="tr-{{$one->id}}">
                                                                ...
                                                                <td>{{@$additions->addition_quantity}}</td>
                        ...
                        <div class="form-actions">
                            <div class="row">
                               <div class="col-md-12">
                                    ...
                                    <a href="{{url(getLocal().'/vender/orders')}}" class="btn default">{{__('cp.cancel')}}</a>
                                </div>
                            </div>
                        </div>
