        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <form method="post" action="{{url(app()->getLocale().'/vender/VenderAddress')}}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                            name="fulladdress" value="{{old('fulladdress',$item[0]->fulladdress) }}" required/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                            name="area" value="{{old('area',$item[0]->area) }}" required/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                            name="street" value="{{old('street',$item[0]->street) }}" required/>
                                </div>
                            </div>
                            {{-- <button type="submit" class="btn btn-success ">{{__('cp.save')}}</button> --}}
                        <button type="submit" id="submitForm" style="display:none"></button>
